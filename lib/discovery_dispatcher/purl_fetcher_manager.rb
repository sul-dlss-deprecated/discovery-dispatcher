...
module DiscoveryDispatcher
  class PurlFetcherManager
    ...
    def self.get_next_start_time
      ...
      return next_start_time.nil? ? Time.parse("1970-01-01T12:00:00").in_time_zone(PACIFIC_TIME_ZONE).iso8601 : next_start_time.in_time_zone(PACIFIC_TIME_ZONE).iso8601
    end
